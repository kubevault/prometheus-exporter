...
> Note: YAML files used in this tutorial stored in [examples](/docs/examples/guides/secret-engines/aws) folder in github repository [KubeVault/docs](https://github.com/kubevault/docs)
