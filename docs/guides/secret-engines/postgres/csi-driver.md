...
Follow [this](/docs/guides/secret-engines/postgres/overview.md) tutorial to manage PostgreSQL credentials with `KubeVault operator`. After successful configuration you should have following resources present in your cluster.
