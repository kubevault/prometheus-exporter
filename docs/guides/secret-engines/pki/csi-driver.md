...
>Note: Yaml files used in this tutorial stored in [docs/examples/csi-driver/pki](/docs/0.1.0/examples/csi-driver/pki) folder in github repository [kubevault/docs](https://github.com/kubevault/docs)
